...
public class Carrier_dispatcher_adapter extends BaseExpandableListAdapter {

    private Context context;
   private ArrayList<Parent_model> list;
    public Carrier_dispatcher_adapter(Context context, ArrayList<Parent_model> parent_models) {
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.carrier_dispatcher_center_list_item, null);
        }
    ...
    public View getGroupView(int listPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.context.
                    getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = layoutInflater.inflate(R.layout.carrier_dispatcher_center_list_group, null);
        }
        ...
        ImageView conter = (ImageView) convertView.findViewById(R.id.listnumber);
