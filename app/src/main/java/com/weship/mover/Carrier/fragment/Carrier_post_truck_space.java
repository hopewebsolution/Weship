...
public class Carrier_post_truck_space extends Fragment implements View.OnClickListener {
    public Carrier_post_truck_space() {
    }
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.carrier_post_truck_space, container, false);
     //   inti(view);
        //clicks lis
       // clicks();
        return view;
