...
public class Customer_bid extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.customer_bid, container, false);
        ...
        expandableListAdapter = new Customer_bid_Adapter(getContext(), expandableListDetail);
