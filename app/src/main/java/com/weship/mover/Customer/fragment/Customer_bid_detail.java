...
public class Customer_bid_detail extends Fragment implements View.OnClickListener {
    public Customer_bid_detail(){}
    View  view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.customer_bid_detail_fragment, container, false);
        inti(view);
        //click listner
        clicks();
        return view;
